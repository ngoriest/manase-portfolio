...
import { Mail, Phone, MapPin, MessageCircle, CheckCircle, AlertCircle, Copy, Check, Sparkles } from 'lucide-react';
...
const Contact = ({ selectedPackage }) => {
  ...
  const contactMethods = [
    ...
    },
    {
      icon: Phone,
      label: 'Phone',
      value: '+254 710 371 770',
      href: 'tel:+254710371770',
  ...
  const handleWhatsAppSubmit = (e) => {
    ...
    const whatsappUrl = `https://wa.me/254710371770?text=${encodedMessage}`;
  ...
  return (
    <section id="contact" className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-gradient-to-b from-[#0a0a0f] via-green-950/10 to-[#0a0a0f]"></div>
        <motion.div
          animate={{ 
            scale: [1, 1.1, 1],
          ...
          className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-gradient-to-tl from-green-500/20 to-transparent rounded-full blur-3xl"
        ></motion.div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="relative group">
              <div className="absolute -inset-1 bg-gradient-to-r from-green-500 to-emerald-500 rounded-3xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-500"></div>
            ...
            {selectedPackage && (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="px-3 py-1 bg-cyan-500/20 text-cyan-400 text-xs font-black rounded-full">
